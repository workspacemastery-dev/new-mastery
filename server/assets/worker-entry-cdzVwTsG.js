...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bt4eaXbu.js");
...
const manifest = {
  "db9c70c47f0c9e135a8dca781d9d3b1253f1939e248a07462a43dab7208ec7b5": {
    ...
    importer: () => import("./admin-users-CckIJkDc.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BfT70NIy.js").then((n2) => n2.r),
